...
UNIT_TESTS_DEPS = snake_utils.o unit_tests.o asserts.o
CUSTOM_TESTS_DEPS = snake_utils.o custom_tests.o asserts.o
...
.PHONY: clean
clean:
	rm -f interactive-snake snake unit-tests custom-tests unit-test-*.snk *.exe *.o tests/*-out.snk
